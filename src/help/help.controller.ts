...
export class HelpController {
  ...
  async getHelps(
    ...
    @Query() getHelpDto: GetHelpDto,
  ): Promise<Help[]> {
    return await this.helpService.getHelps(
      getHelpDto.index,
      getHelpDto.size,
      req.user.id,
    );
  ...
  async writeHelp(
    @Request() req: UserRequest,
    @Body() writeHelpDto: WriteHelpDto,
  ): Promise<Help> {
  ...
  async guestWriteHelp(
    @Request() req: UserRequest,
    @Body() guestWriteHelpDto: GuestWriteHelpDto,
  ): Promise<Help> {
